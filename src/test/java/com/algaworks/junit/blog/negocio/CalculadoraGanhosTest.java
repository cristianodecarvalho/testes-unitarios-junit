...
class CalculadoraGanhosTest {
    ...
    @BeforeEach
    void beforeEach() {
        autor = new Editor(1L, "Cristiano", "cristiano@gmail.com", new BigDecimal(5), true);

        post = new Post(1l, "Ecosistema Java", "O ecosistema do Java é muito maduro", autor, "ecosistema-java-abcd123", null, false, false);
    }

    @Test
    public void Dado_um_post_e_autor_premium_Quando_calcular_ganhos_Entao_deve_retornar_valor_com_ganhos() {
